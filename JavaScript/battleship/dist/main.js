...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _factory_functions_gameboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./factory-functions/gameboard */ \"./src/factory-functions/gameboard.js\");\n/* harmony import */ var _factory_functions_player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./factory-functions/player */ \"./src/factory-functions/player.js\");\n/* harmony import */ var _dom_interface__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dom-interface */ \"./src/dom-interface.js\");\n/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utilities */ \"./src/utilities.js\");\n\r\n\r\n\r\n\r\n\r\nlet gameOver = false;\r\nlet gameStarted = false;\r\n\r\nconst playerBoard = Object(_factory_functions_gameboard__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\r\nconst computerBoard = Object(_factory_functions_gameboard__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\r\nlet shipLengths = [2, 2, 3, 4 ,4];\r\n\r\nconst playerDOMBoard = document.getElementById('player-board');\r\nconst computerDOMBoard = document.getElementById('computer-board');\r\n\r\n_dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].createBoard(playerDOMBoard, handleShipPlacement);\r\n_dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].createBoard(computerDOMBoard, handlePlayerClick);\r\n\r\nconst player = Object(_factory_functions_player__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('Player');\r\nconst computer = Object(_factory_functions_player__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('Computer');\r\n\r\nfunction handlePlayerClick(e) {\r\n    if (gameOver) return;\r\n    if (!gameStarted) return;\r\n    const coords = e.target.getAttribute('data-xy').split(' ');\r\n    const hitType = computerBoard.recieveAttack(coords[0], coords[1]);\r\n    if (hitType !== _factory_functions_gameboard__WEBPACK_IMPORTED_MODULE_0__[\"cellTypes\"].water && hitType !== _factory_functions_gameboard__WEBPACK_IMPORTED_MODULE_0__[\"cellTypes\"].ship) return;\r\n    _dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].markCellDestroyed(e.target);\r\n    player.updateScore(computerBoard);\r\n    if (computerBoard.nSunk() === 5) {\r\n        gameOver = true;\r\n        _dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].declareWinner(player.getName());\r\n        return;\r\n    }\r\n    if (!gameOver) {\r\n        Object(_utilities__WEBPACK_IMPORTED_MODULE_3__[\"makeRandomMove\"])(playerBoard, playerDOMBoard);\r\n        computer.updateScore(playerBoard);\r\n    }\r\n    _dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].updateScores(player, computer);\r\n    if (playerBoard.nSunk() === 5) {\r\n        gameOver = true;\r\n        _dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].declareWinner(computer.getName());\r\n    }\r\n}\r\n\r\nfunction handleShipPlacement(e) {\r\n    if (gameStarted || shipLengths.length === 0) return;\r\n\r\n    const cell = e.target;\r\n    const length = shipLengths.pop();\r\n    const coords = cell.getAttribute('data-xy').split(' ');\r\n    const x = parseInt(coords[0]);\r\n    const y = parseInt(coords[1]);\r\n    const orientation = \r\n        document.getElementById('orientation').value === 'horizontal'\r\n        ? _factory_functions_gameboard__WEBPACK_IMPORTED_MODULE_0__[\"orientations\"].horizontal\r\n        : _factory_functions_gameboard__WEBPACK_IMPORTED_MODULE_0__[\"orientations\"].vertical;\r\n\r\n    const newShip = playerBoard.placeShip(x, y, length, orientation);\r\n\r\n    if(newShip) {\r\n        _dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].placeShip(newShip, x, y, playerDOMBoard, orientation);\r\n        _dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].updateShipPlacementInfo((playerBoard.nShips() + 1),\r\n            shipLengths[shipLengths.length - 1]);\r\n    }\r\n    !newShip && shipLengths.push(length);\r\n    if (playerBoard.nShips() === 5) {\r\n        gameStarted = true;\r\n        _dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].removeShipPlacementInfo();\r\n        _dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].updateScores(player, computer);\r\n    }\r\n}\r\n\r\nconst shipWrappers = computerBoard.placeShipsRandomly();\r\n\r\nshipWrappers.forEach(shipWrapper => {\r\n    _dom_interface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].placeShip(\r\n        shipWrapper.ship, shipWrapper.startCoords.x,shipWrapper.startCoords.y,\r\n        computerDOMBoard, shipWrapper.orientation\r\n    );\r\n});\n\n//# sourceURL=webpack:///./src/index.js?");
