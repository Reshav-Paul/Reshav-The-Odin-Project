...
router.put('/:id', validateUserIdInParam, validateUserIdInBody, commentController.comment_update);
router.delete('/:id', validateUserIdInParam, commentController.comment_delete);
